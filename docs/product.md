...
Submitted project: **CodeGuardian iNFT**.
...
- Autonomous/iNFT: CodeGuardian is the actual iNFT agent.
- Framework/tooling: AgentProof is reusable infrastructure for every 0G iNFT builder.
